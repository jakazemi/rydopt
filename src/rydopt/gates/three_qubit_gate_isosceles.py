...
class ThreeQubitGateIsosceles:
    ...
    def replace(self, **kwargs: Any) -> Self:
        ...
        valid_keys = {"phi", "theta", "theta_prime", "lamb", "Vnn", "Vnnn", "decay", "fidelity_type"}
        ...
        new._theta_prime = kwargs.get("theta_prime", self._theta_prime)
        new._lamb = kwargs.get("lamb", self._lamb)
        new._Vnn = kwargs.get("Vnn", self._Vnn)
        new._Vnnn = kwargs.get("Vnnn", self._Vnnn)
